...
<section class="container" id="prescriptions-edit">
  ...
  <form class="new-form" method="post">
    <div class="form-group">
      ...
      <input type="date" class="text-input" name="last_date" id="last_date" value="<?php echo $prescription['created_at']; ?>" readonly />
    </div>

    <div class="form-group">
      <label for="created_at">Fecha actualizacion</label>
      <input type="date" class="text-input" name="created_at" id="created_at" value="<?php echo $prescription['created_at']; ?>" min="<?php echo $prescription['created_at']; ?>" required />
    </div>

    <div class="form-group">
      <label for="generic_name">Nombre comercial</label>
      <input type="text" class="text-input" name="generic_name" id="generic_name" value="<?php echo $prescription['generic_name']; ?>" readonly />
    </div>
    <div class="form-group">
      <label for="drug">Droga</label>
      <input type="text" class="text-input" name="drug" id="drug" value="<?php echo $prescription['drug']; ?>" readonly />

    </div>

    <div class="form-group">
      <label for="medicine_type">Tipo medicina</label>
      <input type="text" class="text-input" name="medicine_type" id="medicine_type" value="<?php echo $prescription['medicine_type']; ?>" readonly />
    </div>

    <div class="form-group">
      <label for="quantity">Cantidad</label>
      <input type="text" class="text-input" name="quantity" id="quantity" value="<?php echo $prescription['quantity']; ?>" required />
    </div>
    ...
    <div class="form-group">
      ...
      <select class="select" name="professional_id" id="professional_id" required>
        <?php foreach ($professionals as $professional) : ?>
          <option value="<?php echo $professional['id'] ?>" <?php if ($professional['id'] == $prescription['professional_id']) {
                                                              echo 'selected';
                                                            } ?>>
    ...
    <footer>
      ...
      <button class="btn primary" id="confirm-btn" <?php if (empty($professionals)) {
                                                      echo 'disabled';
                                                    } ?>>Cargar</button>
    </footer>
  </form>
